...
+ **-sp[~switches]**&nbsp;  sets up plots for drawing [spectral functions](/tutorial/gw/gw_self_energy/) along symmetry lines.  It:
  ...
  + **out=lmgf**&nbsp; tells **plbnds**{: style="color: blue"} to format _spf.ext_{: style="color: green"} for the [**SpectralFunction.sh**{: style="color: blue"}](/docs/input/commandline/#switches-for-spectralfunctionsh) script
