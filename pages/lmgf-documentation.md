...
The **GF** category has a token **GFOPTS=tag;tag;&hellip;**, which causes **lmgf**{: style="color: blue"} to perform a variety of special purpose functions.
