...
QASA | i | ASA | Y | 3 | A parameter specifying the definition of ASA moments [<i>Q</i><sub>0</sub>,<i>Q</i><sub>1</sub>,<i>Q</i><sub>2</sub>](/docs/code/asaoverview/#generation-of-the-sphere-potential-and-energy-moments-q); see lmto documentation<br>0. Methfessel conventions for 2nd gen ASA moments <i>Q</i><sub>0</sub>,<i>Q</i><sub>1</sub>,<i>Q</i><sub>2</sub><br>1. <i>Q</i><sub>2</sub> = coefficient to $$\dot{\phi}^2{−}p\phi^2$$ in sphere.<br>2. Q1,Q2 accumulated as coefficients to $$\langle \phi \dot{\phi} \rangle>$$ and $$\left<dot{\phi}^2\right>$$, respectively. try $$\dot{\phi}^2$$<br>3. 1+2 (Stuttgart conventions)
