...
DELTA | r | lmfgwd | Y | -1e-4 | δ-function broadening for calculating &chi;<sub>0</sub>, in atomic units.<br>Tetrahedron integration is used if DELTA<0.<br>When generating a GWinput template, lmfgwd passes DELTA to the delta tag.
