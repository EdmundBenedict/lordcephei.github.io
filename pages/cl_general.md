...
:  Specifies the channels for which partial DOS are to be made or analyzed.

**\-\-cls**
:  tells **lmdos**{: style="color: blue"} that the moments file holds data for core-level (EELS) spectrosopy generated by **lmf**{: style="color: blue"}.
