...
:  Various options that affect action of **lmdos**{: style="color: blue"}.\\
   ...
   + tbdos sets defaults for to generate dos generated by **tbe**{: style="color: blue"}, which uses slightly different conventions for the
           moments file, e.g. the moments file is named _band.ext_{: style="color: green"}.
