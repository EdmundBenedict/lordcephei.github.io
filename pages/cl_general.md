...
The generating program uses a switch such as
<pre>
--pdos[~mode=#][~sites=_site-list_][~group=lst1;lst2;...][~nl=#][~lcut=<i>l</i><sub>1</sub>,<i>l</i><sub>2</sub>,...]
--mull[~mode=#][~sites=_site-list_][~group=lst1;lst2;...][~nl=#][~lcut=<i>l</i><sub>1</sub>,<i>l</i><sub>2</sub>,...]
</pre>
