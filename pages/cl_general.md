...
:  Specifies the channels for which partial DOS\\
   &ensp;**\-\-pdos**  partial DOS\\
   &ensp;**\-\-mull**  Mulliken DOS\\
...
**\-\-dos~options**
:  Various options that affect action of **lmdos**{: style="color: blue"}.

        wtfn=<i>filename</i> <i>filename</i> is file containing bands and DOS weights.  By default, **lmdos**{: style="color: blue"} uses
file _moms.ext_{: style="color: green"}
        ...
        tbdos           sets defaults for to generate dos from
                        ...
                        e.g. the moments file is named _band.ext_{: style="color: green"}.
...
<pre>
   \-\-dos:option1:option2...  various options that affect action of **lmdos**{: style="color: blue"}.
      Options are:
        wtfn=<i>filename</i>   <i>filename</i> is file containing bands and DOS
                        weights.  By default, **lmdos**{: style="color: blue"} uses file _moms.ext_{: style="color: green"}
