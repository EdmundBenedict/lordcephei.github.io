...
The connection between the two is:&thinsp; POS<sub><i>i</i></sub> = X<sub>1</sub>P<sub><i>i</i>,1</sub> &thinsp;+&thinsp; X<sub>2</sub> P<sub><i>i</i>,2</sub> &thinsp;+&thinsp; X<sub>3</sub> P<sub><i>i</i>,3</sub>, where P<sub><i>i</i>,<i>j</i></sub> is Cartesian component <i>i</i> of lattice vector <i>j</i>.
