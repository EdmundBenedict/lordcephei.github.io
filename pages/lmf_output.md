...
separate from the potential generated by the density.  Initially this potential is taken from of the free atom; but it is normally
overwritten (**Vfloat=T**). If you tell **lmf**{: style="color: blue"} to freeze it 
([**HAM\_FRZWF=t**](/docs/input/inputfile/#ham) or for one species, [**SPEC\_ATOM\_FRZWF=f**](/docs/input/inputfile/#spec))
