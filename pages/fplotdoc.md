...
Many tools convert postscript files into other forms, e.g. ImageMagick's 'convert' utility will convert .ps
...
The process is slightly complicated by the fact that, for postscript (0,0) is the lower left corner, while for _.svg_{: style="color: green"} it is the upper left corner.
...
This example adapts _fplot.ps_{: style="color: green"} generated from _plot.frames_{: style="color: green"} from
