...
This section develops a few examples to provide an intuitive feel for how the code operates and to illustrate some features.
Section 3 is a manual systematically explaining **fplot**{: style="color: blue"};s features and arguments.
...
This example shows how to use a log scale, customize positioning of tic marks and labelling, use a polynomial to interplate discrete data, and add a key.
