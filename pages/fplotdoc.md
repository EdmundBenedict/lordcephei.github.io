...
scripts to make the process of drawing high quality figures of bands or DOS very easy and efficient,
...
+ **-tp .02:2:.02** generates a data set of one column (the abscissa).  **.02:2:.02** comprises a list of points using [this syntax](/docs/misc/integerlists/).
...
Th manual in this section defines all of the instructions in **fplot**{: style="color: blue"} for fplot version 3.50.

For quick reference, all the commands are listed in the [command index](/docs/misc/fplot/#command-index),
and topics summarized in the [concept index](/docs/misc/fplot/#concept-index).
...
#### **FORMAT** and **LABELLING** switches govern frame layout and labels
{::comment}
/docs/misc/fplot/#format-and-labelling-switches-govern-frame-layout-and-labels
{:/comment}
...
3. As an alternative to reading data from a file you can supply it using the [**-tp**](/docs/misc/fplot/#tp-switch) instruction.
   Most of the examples in [Example 2.1](/docs/misc/fplot/#example-21-nbsp-plot-nbsp-y20x2exp-4x) use this form.
...
+ **-lt _n_[~bold=_b_][~col=#,#,#][~colw=#,#,#][~colw2=#,#,#][~colw3=#,#,#][~clip][~fill=#][~brk=#][~_la_,_lb_,_lc_,_ld_]**\\
  ...
  + **clip**        &emsp;&emsp;&emsp;&ensp;&nbsp;  clips curves as they go outside the frame
...
{::nomarkdown} <a name="tp-switch"></a> {:/}
{::comment}
/docs/misc/fplot/#tp-switch
{:/comment}

+ **-tp [_nc_~]_list_**\\
  generates a table of points.  Optional **_nc_~** specifies the number columns in the list (defaults to 1).\\
  See [Example 2.1](/docs/misc/fplot/#example-21-nbsp-plot-nbsp-y20x2exp-4x) above.
...
+ **-nx \| -ny**\\
  normalizes each column of abscissas and(ordinates) to (0,1)
...
<div onclick="elm = document.getElementById('flowscript'); if(elm.style.display == 'none') elm.style.display = 'block'; else elm.style.display = 'none';"><button type="button" class="button tiny radius"> Click to see script.</button></div>
...
_instructions to specify file format_ | **-r**{: style="color: red"}
...
&nbsp;                                 | Instruction       |  Documentation/Example
|---
&nbsp;                                 | **-k**{: style="color: red"}              | [LABELLING switches](/docs/misc/fplot/#key-switch)
|---
...
&nbsp;                                 | Instruction       |  Documentation/Example | Notes
|---
solid, dashed, dotted lines_           | **-lt _n_**{: style="color: red"}             | [DATA switches](/docs/misc/fplot/#data-switches)
|---
_dash-dot lines_                       | -lt 2~**~#,#,#,#**{: style="color: red"}      | [Dot-dashed lines exercise](/docs/misc/fplot/#dot-dashed-lines)
|---
_color_                                | -lt _n_**~col=_r,g,b_**{: style="color: red"} | [Example 2.4](/docs/misc/fplot/#example-24-nbsp-mobility-in-tlinp)
|---
_thickness_                            | -lt _n_**~bold=#**{: style="color: red"}      |  [Example 2.4](/docs/misc/fplot/#example-24-nbsp-mobility-in-tlinp)
|---
...
_ordinate_ | **-ord _expr_**{: style="color: red"} | [DATA switches](/docs/misc/fplot/#ord-switch)      | [Example 2.1](/docs/misc/fplot/#example-21-nbsp-plot-nbsp-y20x2exp-4x)
...
**-con**      | [DATA switches](/docs/misc/fplot/#contour-switch)    | [Example 2.3](/docs/misc/fplot/#example-23-nbsp-charge-density-contours-in-cr)
**-disp**     | [INIT switches](/docs/misc/fplot/#init-switches-must-occur-first) |
**-ey**       | [DATA switches](/docs/misc/fplot/#error-bar-switch)  | [Error bars exercise](/docs/misc/fplot/#error-bars)
...
**-lbl**      | [LABELLING switches](/docs/misc/fplot/#labelling-switches)  | [Labels exercise](/docs/misc/fplot/#fun-with-labels)
**-lblx**     | [DATA switches](/docs/misc/fplot/#lblx-switch)     |
**-lbly**     | [DATA switches](/docs/misc/fplot/#lblx-switch)     |
...
**-map**      | [DATA switches](/docs/misc/fplot/#map-switch)      |
**-nc**       | [DATA switches](/docs/misc/fplot/#read-switch)     |
...
**-ord**      | [DATA switches](/docs/misc/fplot/#ord-switch)      | [Example 2.1](/docs/misc/fplot/#example-21-nbsp-plot-nbsp-y20x2exp-4x)
**-p**        | [FORMAT switches](/docs/misc/fplot/#x-switch) | [Example 2.1](/docs/misc/fplot/#example-21-nbsp-plot-nbsp-y20x2exp-4x)
