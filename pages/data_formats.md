...
the [**-\-band**](/docs/input/commandline/#band) switch.  How to make _spf.ext_{: style="color: green"} is explained in 
[this document](/docs/code/spectral-functions).

Bash script [**SpectralFunction.sh**{: style="color: blue"}](/docs/input/commandline/#switches-for-spectralfunction-sh) will generate figures directly from _spf.ext_{: style="color: green"}.\\
It contains a 1-line header of **qcut** to be explained below, e.g.
...
~~~
[   E          q-q0         Re A          Im A     ( this line is not present in the file)]
