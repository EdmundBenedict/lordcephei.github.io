...
File _spf.ext_{: style="color: green"}, and site-specific files _spf_{: style="color: green"}n<i>.ext</i>{: style="color: green"} are spectral
functions generated by **lmgf**{: style="color: blue"}, generated with the [**-\-band**](/docs/input/commandline/#band)
switch along [symmetry lines](/docs/input/data_format/#symmetry-line-mode).

Bash script **SpectralFunction.sh**{: style="color: blue"} will generate figures directly from this file

The file contains a 1-line header of **qcut** to be explained below, e.g.
