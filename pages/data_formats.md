...
File _spf.ext_{: style="color: green"}, and site-specific files _spf_{: style="color: green"}n<i>.ext</i>{: style="color: green"} are
...
the [**-\-band**](/docs/input/commandline/#band) switch.  **lmgf**{: style="color: blue"} must be run in the [CPA mode](/docs/code/cpadoc).
