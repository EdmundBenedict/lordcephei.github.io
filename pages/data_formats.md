...
#### File jdos
[//]: (/docs/input/data_format/#file-jdos)

_jdos.ext_{: style="color: green"} is generated by **lmf**{: style="color: blue"} or lm when making 
single or joint DOS when using the optics package (**OPTICS\|MODE**<0)
